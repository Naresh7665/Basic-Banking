...
<head>
  ...
  <link rel="shortcut icon" href="./images/rmgb.png" type="image/png">
...
<body>
  <nav>
    <div class="container-fluid nav-wrapper #00838f cyan darken-3 z-depth-5">
      <a href="index.php" class="brand-logo"><img src="./images/rmgb.png" style="height:55px;width:70px" /></a>
      <ul id="nav-mobile" class="right hide-on-med-and-down">
        <li><a href="index.php">Home</a></li>
        <li><a href="./php/transfermoney.php">Customers</a></li>
  ...
  <div class="center head mt-0">
    <h2><b><span><img src="./images/rmgb.png" style="height:70px;width:90px" /></span>  RMGB BANK</b></h2>
  </div>
        ...
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/bb.png">
            </div>
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img src="./images/rajasthan.jpeg">
            </div>
            <br />

            <h5><b>Welcome to RMGB Bank !</b></h5>
            <br />
    ...
    <div class="col s4">
      ...
      <div class="row">
        <div class="col s12 m6">
          <div class="card small">
            <div class="card-image">
              <img class="cust" src="./images/transactions.png">
            </div>
  ...
  <footer class="center footer">
    <h6 class="info"><b>2021 © Made by Naresh Kumar</b></h6>
